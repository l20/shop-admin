...
<div class="regBox">	
	...
	<form method="post" enctype="multipart/form-data" action="doAction.php?act=reg" >
		<ul class="login">
			<li><span class="reg_item"><i>*</i>用户名：</span><div class="input_item">
			<input type="text"  name="username"  placeholder="请输入用户名" class="login_input user_icon" required="required"></div></li>
			...
			<!-- <button style="border:none;width:266px;height:35px;outline:none;" class="transition"><img src="images/reg.jpg" alt="" /></button> -->
				<input type="submit" value="立即注册" class="reg-btn transition">
			</li>
		</ul>
		</form>
	</div>
