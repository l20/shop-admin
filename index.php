	...
	<div class="rightArea">
		<div class="shopList_top clearfix">
			<?php 
				if (is_array($pros)):
					foreach ($pros as $pro):
						$proImgs = getProImgById($pro['id'],$link);
			?>
			<div class="shop_item">
				<div class="shop_img">
					<a href="proDetails.php?id=<?php echo $pro['id']; ?>">
					<?php foreach ($proImgs as $proImg) :
						 $fileName = explode(".", $proImg['albumPath']);
					?>
					<img width="187" height="200" src="images_350/<?php echo $fileName[0]."_350x350".".".$fileName[1]; ?>" > 
					<?php endforeach; ?>
					</a>
				</div>
				<h3><?php echo $pro['pName']; ?></h3>
				<p><?php echo $pro['mPrice']; ?></p>
			</div>
			<?php  endforeach; ?>
			<?php  endif; ?>
		</div>
		<div class="shopList_sm clearfix">
			<?php 
				if (is_array($pros)):
					foreach ($pros as $pro):
						$proImgs = getSmallImgById($pro['id'],$link);
					echo $proImgs[1][0];
			?>
			<div class="shopItem_sm">
				<div class="shopItem_smImg">
					<?php //foreach ($proImgs as $proImg) :
						 $fileName = explode(".", $proImgs[1][0]);
					?>
					<a href="proDetails.php?id=<?php echo $pro['id']; ?>">
					<img src="images_50/<?php echo $fileName[0]."_50x50".".".$fileName[1]; ?>" ></a>
					<?php //endforeach; ?>
				</div>
				<div class="shopItem_text">
					<p>NFC技术一碰轻松配对！接触屏幕</p>
					<h3><?php echo $pro['mPrice']; ?></h3>
				</div>
			</div>
			<?php  endforeach; ?>
			<?php  endif; ?>
