...
<div class="loginBox">
	...
	<form method="post" action="doAction.php?act=login" >
		<ul class="login">
			...
			<li><input type="submit" value="" class="login_btn transition"></li>
			<!-- <li><input type="submit" value="登录" class="login_btn transition"></li> -->
		</ul>
		</form>
...
<div class="hr_25"></div>
<div class="footer">
	<p> <a href="#">招纳贤士</a><i>|</i><a href="#">联系我们</a><i>|</i>客服热线：400-675-1234</p>
	<p>Copyright &copy; 2006 - 2014 aw版权所有&nbsp;&nbsp;&nbsp;京ICP备09037834号&nbsp;&nbsp;&nbsp;京ICP证B1034-8373号&nbsp;&nbsp;&nbsp;某市公安局XX分局备案编号：123456789123</p>
