...
$row = getProById($id, $link);

$cate = getCateNameByCid($row['cId'], $link);

$cates = getAllCate($link);
if (!$row && is_array($row)) {
	alertMes("不好意思，网站维护中！", "http://localhost:8088/");
}
...
<div class="userPosition comWidth">
	...
	<span>&nbsp;&gt;&nbsp;</span>
	<a href="#"><?php echo $cate['cName']; ?></a>
	<span>&nbsp;&gt;&nbsp;</span>
	<em><?php echo $row['pSn']; ?></em>
</div>
<div class="description_info comWidth">
	<div class="description clearfix">
		<div class="leftArea">
			<div class="description_imgs">
				<div class="big jqzoom"  rel='gal1'  title="triumph" >
           			 <img width="309" height="340" src="images/des_big.jpg"  title="triumph">
		...
		<div class="rightArea">
			<div class="des_content">
				<h3 class="des_content_tit"><?php echo $row['pName']; ?></h3>
				<div class="dl clearfix">
					<div class="dt">特惠价</div>
					<div class="dd clearfix"><span class="des_money"><em>￥</em><?php echo $row['mPrice']; ?></span></div>
				</div>
				<div class="dl clearfix">
					<div class="dt">优惠</div>
